...
<body>
    <center>
        <div class="container">
            ...
            <div class="content">
                <div class="gridlebron1"></div>
                <div class="gridlebron2"></div>
                <div class="gridlebron3"></div>
                <div class="gridlebron4"></div>
                <div class="gridfreakleft">
                            ...
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th colspan="2">
                                        ...
                                        <option value="LeBron 18">LeBron 18</option>
                                        </select>
                                    </th>
                                <tr>
                                <tr>
                                    <th colspan="2">
                                        ...
                                        <option value="Rp 2,999,000">Rp 2,999,000</option>
                                        </select>
                                    </th>
                                </tr>
                                    <th colspan="2">
                    ...
                    <div class="p"><p>
                    When LeBron accelerates down the court, he produces tremendous force. 
                    The LeBron 18 is designed to harness his abilities while helping with 
                    the stress he puts on his body. Combined cushioning underfoot allows 
                    him to use his power for unstoppable bursts of speed.
                    </p></div>
                    <br><br><br><br>
                </div>
            </div>
